...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
	...
	<p>
		...
		achieving high levels of patient and customer care in a professional, caring environment:</p>
	...
	<h1 class="ServicesInDetail">
		Services in Detail:</h1>
	<p>
	...
	<p>
		...
		day including weekends so get in touch with us as soon as you can.</p>
	<p>
		...
		of staff or telephone the number above.</p>
	<p>
		...
		We can help you put this right to save you time.</p>
	<p>
		...
		you on safe storage of medicines.</p>
	<p>
		<a href="Consultations.aspx"><strong>Health Checks, Advice &amp; Consultations</strong></a>
		services are available in our private Consultation Room.</p>
	<p>
		...
		returning your unwanted medicines to this pharmacy, <a href="medicine_old_returnof01.aspx">
			please take a moment to answer these quick questions</a>.</p>
	<p>
		...
		Scales, Pregnancy Testing Kits, etc. <strong>We can also order any product upon request
			at competitive prices.</strong></p>
	<p class="para_last">
		...
		and adverse effects. Checks can be made with medication bought over the counter.</p>
	<p>
		<img src="Images/nhs-pharmacy-logo-small.gif" alt="Providing NHS Services" width="62"
			height="70" class="logo01" />
		<img src="images/nhs-services-logo-small.gif" alt="NHS Services Available Here" width="140"
			height="70" class="logo01" />
