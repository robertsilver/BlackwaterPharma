...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="health-home">
        ...
        <p class="para_leftmar01">
            <strong>Your gateway to a comprehensive range of health resources and services</strong>.
        </p>
        <h1 class="HealthHome">Health Links:</h1>
        <p>
            In addition, we have also a included useful links to <a href="HealthLinks.aspx">medical
			documents, local services, professional associations and related resources</a>.
        </p>
        <h1 class="HealthHome">Medicine Chest:
        </h1>
        <p>
            Our <a href="Health_Medichest.aspx">Medicine Chest</a> has our recommendations
		of useful medicines and dressings you should keep at home.
        </p>
        <p>
