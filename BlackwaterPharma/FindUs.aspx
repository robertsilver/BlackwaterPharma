...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <div class="find-us">
        <h1 class="PatientAndCustomerServices">Finding Us:
        </h1>
        ...
        <div style="float: left; width: 100%">
            <div style="float: left">
                <iframe width="640" height="480" frameborder="0" scrolling="no" marginheight="0"
                    marginwidth="0" src="http://maps.google.co.uk/maps/ms?hl=en&amp;ie=UTF8&amp;msa=0&amp;msid=105957720306161528472.000485b499290fb6a5766&amp;ll=51.728357,0.680895&amp;spn=0.012759,0.027466&amp;z=15&amp;output=embed"></iframe>
                <br />
        ...
        <br />
        <div style="float: left">
            <h1 class="MediChestContents">Disabled Customers:</h1>
            <p class="para_last">
			...
			further assistance whilst in the store.
            </p>
            <p>
